<?php include "incl/hdr.php";$ins=true;?>
...
<?php include "incl/sty.css";?></head><body onLoad="fc()">
<form action="main.php" target="a" method="post" onSubmit="tu()"><table align="center" border="0" width="450">
<tr><td colspan="3"><input type="text" id="inp" name="xyz" size="65" maxlength="180" class="ia"></td>
